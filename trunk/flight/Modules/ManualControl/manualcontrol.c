 ...
 * StabilizationDesired object (stabilized mode)
 *
...
static void manualControlTask(void *parameters)
{
	...
	StabilizationDesiredData stabi;
		...
		if (cmd.FlightMode == MANUALCONTROLCOMMAND_FLIGHTMODE_MANUAL) {
			...
			switch(cmd.StabilizationSettings[MANUALCONTROLCOMMAND_STABILIZATIONSETTINGS_ROLL]) {
				case MANUALCONTROLCOMMAND_STABILIZATIONSETTINGS_RATE:
					stabi.Roll = cmd.Roll * stabSettings.ManualRate[STABILIZATIONSETTINGS_MANUALRATE_ROLL];
					break;
				case MANUALCONTROLCOMMAND_STABILIZATIONSETTINGS_ATTITUDE:
					stabi.Roll = cmd.Roll * stabSettings.RollMax;
					break;
			...
			switch(cmd.StabilizationSettings[MANUALCONTROLCOMMAND_STABILIZATIONSETTINGS_PITCH]) {
				case MANUALCONTROLCOMMAND_STABILIZATIONSETTINGS_RATE:
					stabi.Pitch = cmd.Pitch * stabSettings.ManualRate[STABILIZATIONSETTINGS_MANUALRATE_PITCH];
					break;
				case MANUALCONTROLCOMMAND_STABILIZATIONSETTINGS_ATTITUDE:
					stabi.Pitch = cmd.Pitch * stabSettings.PitchMax;
					break;
				case MANUALCONTROLCOMMAND_STABILIZATIONSETTINGS_NONE:
					stabi.Pitch = cmd.Pitch;
					break;
			}
			switch(cmd.StabilizationSettings[MANUALCONTROLCOMMAND_STABILIZATIONSETTINGS_YAW]) {
				case MANUALCONTROLCOMMAND_STABILIZATIONSETTINGS_RATE:
					stabi.Yaw = cmd.Yaw * stabSettings.ManualRate[STABILIZATIONSETTINGS_MANUALRATE_YAW];
					break;
				case MANUALCONTROLCOMMAND_STABILIZATIONSETTINGS_ATTITUDE:
					stabi.Yaw = fmod(cmd.Yaw * 180.0, 360);
					break;
				case MANUALCONTROLCOMMAND_STABILIZATIONSETTINGS_NONE:
					stabi.Yaw = cmd.Yaw;
					break;
